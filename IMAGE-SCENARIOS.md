...
|---|---:|---:|---:|
| Editorial pages in the sitemap | 147 | 60 | 87 |
| Non-indexed utility pages | 2 | 0 | 2 |
| **All rendered pages** | **149** | **60** | **89** |
...
| `pages/perfect-for/scare-attractions.md` | [x] Admin screenshot: `industry-scare-attraction-calendar` | Hollowtree Scare Trail's admin calendar with Thursday-to-Sunday nights bookable and 25 of 40 places remaining on a Friday. | Shows a short season with per-night capacity and closed weeknights. |
