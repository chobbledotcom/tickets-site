...
blocks:
  ...
  - type: features
    ...
    items:
      ...
      - icon: hugeicons:ticket-01
        description: An Australian platform charging 1.8% + A$0.30 on each paid sale, with AI event setup and its own event listings. Compare per-sale charges with a flat annual fee.
