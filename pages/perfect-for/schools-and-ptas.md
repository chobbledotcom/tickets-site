...
meta_description: Ticketing for school discos, fairs, and PTA fundraisers with no per-ticket fees, encrypted attendee data, and a 50% discount for PTAs.
...
blocks:
  - type: hero
    ...
    content: |-
      ...
      Sell tickets for school discos, fairs, and performances with no per-ticket fees, and a 50% discount for PTAs and other community groups.
  - type: split-icon-links
    ...
    content: |
      ...
      [no per-ticket fees](/features/no-per-ticket-fees/). PTAs and
      community groups pay **£25/year** (50% off the standard £50/year),
  ...
  - type: features
    ...
    items:
      - icon: hugeicons:qr-code
        description: Each ticket has a unique QR code. Volunteers scan it on the door with a phone camera, with no app to install.
