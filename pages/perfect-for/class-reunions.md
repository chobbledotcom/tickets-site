---
title: Class Reunions - Chobble Tickets
meta_title: Class Reunion Ticketing - Chobble Tickets
meta_description: Ticketing for class reunions and alumni events, with meal choices, dietary questions, encrypted guest data and £5 monthly billing for one-off events.
permalink: /perfect-for/class-reunions/
eleventyNavigation:
  key: Class Reunions
  parent: Perfect For
  order: 26
blocks:
  ...
  - type: split-icon-links
    content: |
      ...
      Guest names and contact details are
      [encrypted at rest](/features/encrypted/). Chobble Tickets has no
      event marketplace and sends no marketing to your guests; the only
      ...
      On the night, tickets can be
      [checked off by phone scan or name search](/features/qr-code-check-ins/),
      or the exported list can be printed and used at the door.
    figure_items:
      - icon: hugeicons:lock
  ...
  - type: features
    dark: true
    intro_content: "## Features for reunion organisers"
    items:
      - icon: hugeicons:help-circle
        description: Collect meal choices, dietary requirements, and guest names at checkout, with answers in every list and export.
  ...
  - type: cta
    ...
    content: |-
      ...
      Sign up for managed hosting at £5/month or £50/year with no Chobble per-ticket platform fee.
name: Class Reunion Ticketing - Chobble Tickets
---
