...
blocks:
  ...
  - type: markdown
    content: |
      ...
      Organisers decide which contact fields to collect. They can run free events without a payment provider and can make email addresses optional, except on a paid listing taking payment through <a href="/features/stripe-and-square/">Square</a>, whose checkout will not open without one.
