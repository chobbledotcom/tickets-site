...
blocks:
  ...
  - type: markdown
    content: |
      ...
      Configure a webhook URL per event or set a global webhook for all
      bookings. When someone registers, Chobble Tickets sends a POST request
      with the attendee details, ticket information, and pricing data.
