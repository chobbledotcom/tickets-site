export const SOCIAL_SCREENSHOT_COPY = {
  ...
  "charity-events": {
    ...
    body: "Put adult and child tickets in one checkout. Chobble Tickets does not take a percentage of ticket revenue.",
  },
  "confirmation-email-template-editor": {
    heading: "Write your own emails",
    body: "Change confirmation emails and include details from the attendee, order and ticket in each message.",
  },
  "custom-questions": {
